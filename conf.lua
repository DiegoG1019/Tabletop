local title = "DnD Tabletop"

function love.conf(t)
    
    t.identity = title                   -- The name of the save directory (string)
    ...
    t.window.width = 120                 -- The window width (number)
    t.window.height = 50                 -- The window height (number)
